...
export interface ApiGuideGuide extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    coverCardDesktop: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    coverCardMobile: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    coverDesktop: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    highlights: Schema.Attribute.Component<'section.highlights', false>;
...
export interface ApiLocationLocation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['city', 'route', 'region', 'neighborhood']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::page.page'> &
      Schema.Attribute.Private;
    popup: Schema.Attribute.Component<'media.popup', false>;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'meta.seo', false>;
    slug: Schema.Attribute.String;
    title: Schema.Attribute.String;
